...
public class LifecycleMethodVisitor extends MethodVisitor {
    ...
    public void visitCode() {
        super.visitCode();
        visitLabel(newStart);
        File destFile = new File("D:/Android/Project/GetMethodList/MethodList2.txt");
        //如果文件不存在就全插
...
//            mv.visitLdcInsn(methodName + "_" + lineNumber);
            ...
            mv.visitIntInsn(Opcodes.SIPUSH, 2000);
            mv.visitMethodInsn(Opcodes.INVOKESTATIC, "realtimecoverage/MethodVisitor", "tearDown", "(I)V", false);
        }
        super.visitInsn(opcode);
    }
